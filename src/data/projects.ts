...
export const projects: Project[] = [
  ...
  // Research Projects
  {
    ...
    metrics: {
      impact: '$38M Year 5 revenue, 2M patients served, 40K+ early PsA detection',
  ...
  },
  {
    ...
    metrics: {
      impact: 'AI interprets abstract concepts into visual exhibitions',
      improvement: 'Democratizing art curation through conversational AI',
    },
    links: [
