...
export const HeroNew = ({ onSummon, isLoading }: HeroNewProps) => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center text-center px-4 overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto w-full space-y-8">
        ...
        <ScrollytellingSection animationType="fade-up" delay={600}>
          <h1 className="font-bold text-white tracking-[-0.03em] leading-[1.05] text-[clamp(2.5rem,8vw,5rem)] gradient-shimmer">
            The Archive Awakens
          </h1>
        </ScrollytellingSection>
        ...
        <ScrollytellingSection animationType="fade-up" delay={1200}>
          <p className="max-w-3xl mx-auto text-base md:text-lg text-white/70 leading-relaxed">
