      ...
      <nav style={{
        ...
        */}
        <div style={{
          ...
          inset: 0,
          background: scrolled
            ? `radial-gradient(ellipse 200% 100% at top, var(--glass-15) 0%, var(--glass-08) 60%),
               linear-gradient(180deg,
                 rgba(20, 20, 20, 0.85) 0%,
                 rgba(15, 15, 15, 0.80) 50%,
                 rgba(20, 20, 20, 0.85) 100%)`
            : 'transparent',
          backdropFilter: scrolled ? 'blur(40px) saturate(180%) brightness(0.85) contrast(1.1)' : 'blur(20px) saturate(120%)',
          WebkitBackdropFilter: scrolled ? 'blur(40px) saturate(180%) brightness(0.85) contrast(1.1)' : 'blur(20px) saturate(120%)',
