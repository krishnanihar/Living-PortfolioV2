      ...
      <nav style={{
        ...
        */}
        <div style={{
          ...
          inset: 0,
          background: scrolled
            ? `radial-gradient(ellipse 200% 100% at top, var(--glass-12) 0%, transparent 40%),
               linear-gradient(135deg,
                 rgba(10, 10, 10, 0.6) 0%,
                 rgba(0, 0, 0, 0.5) 50%,
                 rgba(10, 10, 10, 0.6) 100%)`
            : 'transparent',
          backdropFilter: scrolled ? 'blur(100px) saturate(200%) brightness(0.95)' : 'blur(20px) saturate(120%)',
          WebkitBackdropFilter: scrolled ? 'blur(100px) saturate(200%) brightness(0.95)' : 'blur(20px) saturate(120%)',
          borderBottom: scrolled ? '1px solid var(--glass-10)' : '1px solid transparent',
          boxShadow: scrolled
            ? `inset 0 1px 0 var(--glass-20),
               inset 0 2px 8px var(--glass-08),
               inset 0 -1px 2px rgba(0, 0, 0, 0.6),
               inset 0 0 40px var(--glass-02),
               0 8px 32px rgba(0, 0, 0, 0.6),
               0 20px 60px rgba(0, 0, 0, 0.3),
               0 0 0 1px var(--glass-06)`
            : 'none',
          pointerEvents: 'none',
          transition: 'all 0.3s cubic-bezier(0.16, 1, 0.3, 1)',
