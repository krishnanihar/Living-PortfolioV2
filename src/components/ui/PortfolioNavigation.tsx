      ...
      <nav style={{
        ...
        */}
        <div style={{
          ...
          inset: 0,
          background: scrolled
            ? `radial-gradient(ellipse 200% 100% at top, var(--glass-20) 0%, transparent 50%),
               linear-gradient(180deg,
                 var(--glass-15) 0%,
                 var(--glass-08) 50%,
                 var(--glass-12) 100%)`
            : 'transparent',
          backdropFilter: scrolled ? 'blur(80px) saturate(180%) brightness(1.02)' : 'blur(20px) saturate(120%)',
          WebkitBackdropFilter: scrolled ? 'blur(80px) saturate(180%) brightness(1.02)' : 'blur(20px) saturate(120%)',
          borderBottom: scrolled ? '1px solid var(--glass-15)' : '1px solid transparent',
          boxShadow: scrolled
            ? `inset 0 1px 1px var(--glass-25),
               inset 0 2px 4px var(--glass-10),
               inset 0 -1px 2px rgba(0, 0, 0, 0.4),
               inset 0 0 30px var(--glass-03),
