...
interface NarrativeProgressIndicatorProps {
  showLabels?: boolean;
  position?: 'left' | 'right';
}

/**
 * Visual indicator showing narrative position and act
 * Provides wayfinding for users through the speculative journey
 */
  ...
  const acts = [
    {
      id: 'seduction',
      label: 'The Promise',
      description: 'What if dreams were data?',
      icon: Brain,
      range: [0, 0.3],
    ...
    },
    {
      id: 'resolution',
      label: 'The Questions',
      description: 'What should we ask?',
      icon: HelpCircle,
      range: [0.7, 1],
