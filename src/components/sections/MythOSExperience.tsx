      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '2rem', fontSize: '0.9375rem', letterSpacing: '0.005em' }}>
            <a href="#browse" style={{ color: 'var(--text-primary)', textDecoration: 'none', transition: 'color var(--duration-fast) ease' }}>Browse</a>
            <a href="#about" style={{ color: 'var(--text-secondary)', textDecoration: 'none', transition: 'color var(--duration-fast) ease' }}>About</a>
          </div>
        </div>
      </nav>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <ParallaxSection speed={0.2} direction="up">
            ...
            <div style={{
              ...
              <p style={{ marginBottom: '1.5rem' }}>
                <strong style={{ color: 'var(--text-primary)' }}>What if art history spoke your language?</strong>
              </p>
              <p style={{ marginBottom: '1.5rem' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '1.0625rem', lineHeight: '1.7', color: 'var(--text-primary)' }}>
